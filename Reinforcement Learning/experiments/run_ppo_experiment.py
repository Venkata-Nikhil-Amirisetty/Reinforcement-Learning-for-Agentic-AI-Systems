"""
Experiment script for PPO tutorial agent.
"""
import sys
import os
import numpy as np
...
def run_experiment(
    ...
    output_dir: str = "experiments/results/ppo"
):
    """
    Run PPO experiment.
    ...
    print("=" * 60)
    print("PPO Tutorial Agent Experiment")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="experiments/results/ppo", help="Output directory")
